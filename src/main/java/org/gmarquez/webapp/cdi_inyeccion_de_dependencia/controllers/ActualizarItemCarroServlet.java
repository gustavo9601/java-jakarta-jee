...
import org.gmarquez.webapp.cdi_inyeccion_de_dependencia.services.ProductoServiceImlp;

import java.io.IOException;
import java.util.Arrays;
import java.util.List;

@WebServlet("/cdi_inyeccion_de_dependencia/actualizar-item-carro-servlet")
public class ActualizarItemCarroServlet extends HttpServlet {
    ...
    private void eliminarItemsCarro(HttpServletRequest req, Long[] indices) {
        if (indices != null) {
            ...
            this.actualizarSesionCarro(req, this.carro);
        }
    }
