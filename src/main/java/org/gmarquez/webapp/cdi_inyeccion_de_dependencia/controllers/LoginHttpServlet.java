...
import org.gmarquez.webapp.cdi_inyeccion_de_dependencia.services.UsuarioService;
import org.gmarquez.webapp.cdi_inyeccion_de_dependencia.services.UsuarioServiceImpl;
...
@WebServlet("/cdi_inyeccion_de_dependencia/login")
public class LoginHttpServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (sessionOptional.isPresent()) { // si existe la sesion
            ...
            getServletContext().getRequestDispatcher("/cdi_inyeccion_de_dependencia/formulario_login.jsp").forward(req, resp);
        }
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (this.usuarioService.login(usuario, password).isPresent()) {
            ...
            resp.getWriter().write(" <a href='" + req.getContextPath() + "/cdi_inyeccion_de_dependencia/inicio'>Inicio</a><br>");
            resp.getWriter().write(" <a href='" + req.getContextPath() + "/cdi_inyeccion_de_dependencia/tabla_productos'>Tabla de productos</a>");
