...
<%@ page import="org.gmarquez.webapp.sessions.models.Carro" %>
<%@ page import="org.gmarquez.webapp.sessions.models.ItemCarro" %><%--
...
<% if (carro == null || carro.estaVacio()) { %>
<p>No hay productos en el carro</p>
<% } else { %>


<form action="<%=request.getContextPath()%>/sessions/actualizar-item-carro-servlet" method="post">
    <table>
        <thead>
        <tr>
        <tr>id</tr>
...
<hr>
<p>
    <a href="<%=request.getContextPath()%>/sessions/tabla_productos">Tabla productos</a>
</p>
<p>
